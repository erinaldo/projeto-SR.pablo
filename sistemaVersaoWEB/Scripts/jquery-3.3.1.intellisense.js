intellisense.annotate(jQuery, {
  ...
  'dequeue': function() {
    ...
    ///   <param name="queueName" type="String">A string containing the name of the queue. PainelPrincipals to fx, the standard effects queue.</param>
    /// </signature>
  },
  'each': function() {
    /// <signature>
  ...
  'get': function() {
    ...
    ///   <param name="dataType" type="String">The type of data expected from the server. PainelPrincipal: Intelligent Guess (xml, json, script, or html).</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'getJSON': function() {
  ...
  'post': function() {
    ...
    ///   <param name="dataType" type="String">The type of data expected from the server. PainelPrincipal: Intelligent Guess (xml, json, script, text, html).</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'proxy': function() {
...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'isPainelPrincipalPrevented': function() {
    /// <summary>Returns whether event.preventPainelPrincipal() was ever called on this event object.</summary>
    /// <returns type="Boolean" />
  },
  ...
  'preventPainelPrincipal': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'stop': function() {
    ...
    ///   <param name="clearQueue" type="Boolean">A Boolean indicating whether to remove queued animation as well. PainelPrincipals to false.</param>
    ///   <param name="jumpToEnd" type="Boolean">A Boolean indicating whether to complete the current animation immediately. PainelPrincipals to false.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Stop the currently-running animation on the matched elements.</summary>
